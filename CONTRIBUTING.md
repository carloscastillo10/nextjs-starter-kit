...
| `pnpm gates`            | All of the above, plus the environment checks and the build, read out of the CI workflow                                                                        |
...
| -------------------- | ----------------- | -------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ci.yml`             | `Checks`          | Every pull request and every push to `main`                                | `pnpm format`, `lint` (with `lint:arch` and `lint:deps`), `lint:ws`, `lint:boundaries`, `lint:comments`, `lint:echo`, `types:check`, `test`, `spell:check`, `lint:md`, `lint:frontmatter`, `env:check`, `env:check:turbo`, `build` |
