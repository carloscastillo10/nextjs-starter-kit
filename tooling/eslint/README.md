...
| [`syntax.js`](./syntax.js) | `BASE_SYNTAX`, `COMPONENT_SYNTAX`, `APP_COMPONENT_SYNTAX`, `SLICE_UI_SYNTAX`, `UI_KIT_SYNTAX` | Selector lists for `no-restricted-syntax`, composed by the presets                                                  |
